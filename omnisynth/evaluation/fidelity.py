...
from omnisynth.config import DEFAULT_CONFIG, EvalConfig
from omnisynth.metrics.base import MetricResult
...
from omnisynth.utils.data_utils import ColumnTypes, align_columns, detect_column_types
...
def evaluate_fidelity(
    ...
    config:
        Optional :class:`~omnisynth.config.EvalConfig` with metric-level knobs.
